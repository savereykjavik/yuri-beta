...
function init() {
	...
	setTimeout(function(){ typeIt('t1-1', 160, 2)}, 2900);
	setTimeout(function(){ typeIt('t1-2', 200, 30)}, 4000);
	...
	//FRAME 6
	setTimeout(function(){ typeIt('t2-1', 120, 2)}, 9800);
	setTimeout(function(){ typeIt('t2-2', 230, 30)}, 11100);
